...
const ImageSlider = () => {
  ...
  const generateRandomDate = () => {
    const remainingDaysInMarch = Array.from({ length: 16 - new Date().getDate() }, (_, i) => i + new Date().getDate() + 1);
    const randomDay = remainingDaysInMarch[Math.floor(Math.random() * remainingDaysInMarch.length)];
